...
public class VehiculoModificarServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        boolean var; 
        var = dao.saveOrInsert(id2, marca, modelo, año2, motor2, kilometraje2, color, precio2);
        if (var == true){
        	request.setAttribute("vehiculo", dao.saveOrInsert(id2, marca, modelo, año2, motor2, kilometraje2, color, precio2));
